...
func generateInventoryState() *inventory.InstanceInventory {
	return &inventory.InstanceInventory{
		...
		InstalledPackages: &packages.Packages{
			Yum:           []*packages.PkgInfo{{Name: "YumInstalledPkg", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			Rpm:           []*packages.PkgInfo{{Name: "RpmInstalledPkg", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			Apt:           []*packages.PkgInfo{{Name: "AptInstalledPkg", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			Deb:           []*packages.PkgInfo{{Name: "DebInstalledPkg", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			Zypper:        []*packages.PkgInfo{{Name: "ZypperInstalledPkg", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			ZypperPatches: []*packages.ZypperPatch{{Name: "ZypperInstalledPatch", Category: "Category", Severity: "Severity", Summary: "Summary"}},
			Gem:           []*packages.PkgInfo{{Name: "GemInstalledPkg", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			Pip:           []*packages.PkgInfo{{Name: "PipInstalledPkg", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			GooGet:        []*packages.PkgInfo{{Name: "GooGetInstalledPkg", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			...
			COS: []*packages.PkgInfo{{Name: "CosInstalledPkg", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
		},
		PackageUpdates: &packages.Packages{
			Yum:           []*packages.PkgInfo{{Name: "YumPkgUpdate", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			Apt:           []*packages.PkgInfo{{Name: "AptPkgUpdate", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			Zypper:        []*packages.PkgInfo{{Name: "ZypperPkgUpdate", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			ZypperPatches: []*packages.ZypperPatch{{Name: "ZypperPatchUpdate", Category: "Category", Severity: "Severity", Summary: "Summary"}},
			Gem:           []*packages.PkgInfo{{Name: "GemPkgUpdate", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			Pip:           []*packages.PkgInfo{{Name: "PipPkgUpdate", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			GooGet:        []*packages.PkgInfo{{Name: "GooGetPkgUpdate", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			WUA: []*packages.WUAPackage{{
				Title:                    "WUAUpdate",
				Description:              "Description",
				Categories:               []string{"Category"},
...
func TestWrite(t *testing.T) {
	inv := &inventory.InstanceInventory{
		...
		Version:       "Version",
		InstalledPackages: &packages.Packages{
			Yum: []*packages.PkgInfo{{Name: "Name", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
			WUA: []*packages.WUAPackage{{Title: "Title"}},
			QFE: []*packages.QFEPackage{{HotFixID: "HotFixID"}},
		},
		PackageUpdates: &packages.Packages{
			Apt: []*packages.PkgInfo{{Name: "Name", Arch: packages.NewArchitecture("Arch"), Version: "Version"}},
		},
		OSConfigAgentVersion: "OSConfigAgentVersion",
