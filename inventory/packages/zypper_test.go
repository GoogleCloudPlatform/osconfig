...
func TestZypperInstalls(t *testing.T) {
	util.Run = getMockRun([]byte("TestZypperInstalls"), nil)
...
func TestZypperInstallsReturnError(t *testing.T) {
	util.Run = getMockRun([]byte("TestZypperInstallsReturnError"), errors.New("Could not find package"))
	if err := InstallZypperPackages(pkgs); err == nil {
...
func TestRemoveZypper(t *testing.T) {
	util.Run = getMockRun([]byte("TestRemoveZypper"), nil)
...
func TestRemoveZypperReturnError(t *testing.T) {
	util.Run = getMockRun([]byte("TestRemoveZypperReturnError"), errors.New("Could not find package"))
	if err := RemoveZypperPackages(pkgs); err == nil {
		t.Errorf("unexpected error: %v", err)
	}
}
...
func TestZypperUpdates(t *testing.T) {
	util.Run = getMockRun([]byte("v | SLES12-SP3-Updates  | at                     | 3.1.14-7.3      | 3.1.14-8.3.1      | x86_64"), nil)
...
func TestZypperPatches(t *testing.T) {
	util.Run = getMockRun([]byte("SLE-Module-Basesystem15-SP1-Updates | SUSE-SLE-Module-Basesystem-15-SP1-2019-1258 | recommended | moderate  | ---         | needed     | Recommended update for postfix"), nil)
...
func TestZypperInstalledPatches(t *testing.T) {
	util.Run = getMockRun([]byte("SLE-Module-Basesystem15-SP1-Updates | SUSE-SLE-Module-Basesystem-15-SP1-2019-1258 | recommended | moderate  | ---         | applied     | Recommended update for postfix"), nil)
