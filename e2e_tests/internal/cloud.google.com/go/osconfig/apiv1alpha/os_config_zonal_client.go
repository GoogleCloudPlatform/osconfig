...
// manage package installations and patch jobs for Compute Engine instances.
...
// CreateOSPolicyAssignment create a new OS policy assignment.
//
// This also creates the first revision of the OS policy assignment.
//
// This method returns a long running operation(LRO) that contains the rollout
// details. The rollout can be cancelled by cancelling the LRO.
...
//
// This creates a new revision of the OS policy assignment.
//
// This method returns a long running operation(LRO) that contains the rollout
// details. The rollout can be cancelled by cancelling the LRO.
...
//
// This always returns the latest revision. In order to retrieve a previous
// revision of the assignment, also provide the revision ID.
//
// Format:
...
// GetInstanceOSPoliciesCompliance get OS policies compliance data for the specified Compute Engine instance.
...
// ListInstanceOSPoliciesCompliances list OS policies compliance data for all Compute Engine instances in the
// specified zone.
