...
this is junk data`
	...
	tests := []struct {
		...
		{"NormalCase", []byte(normalCase), []*PkgInfo{{Name: "at", Arch: NewArchitecture("x86_64"), Version: "3.1.14-8.3.1"}, {Name: "autoyast2-installation", Arch: NewArchitecture("noarch"), Version: "3.2.22-2.9.2"}}},
...
func TestZypperUpdates(t *testing.T) {
	...
	want := []*PkgInfo{{Name: "at", Arch: NewArchitecture("x86_64"), Version: "3.1.14-8.3.1"}}
